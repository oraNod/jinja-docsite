...
BLOG_AUTHOR = "Ansible Community, et al"
BLOG_TITLE = "Ansible Community"
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://docs.ansible.com/"
...
try:
    ...
    GLOBAL_CONTEXT = {
        ...
        "index": load_data("data/index.yaml"),
        "links": load_data("data/links.yaml"),
        "maintainers": load_data("data/maintainers.yaml"),
        "pages": load_data("data/pages.yaml"),
        "platform": load_data("data/platform.yaml"),
        "controller_archive": load_data("data/controller_archive.yaml"),
        "controller_i18n_links": load_data("data/controller_i18n_links.yaml"),
        "controller_translations": load_data("data/controller_translations.yaml"),
        "core_translations": load_data("data/core_translations.yaml"),
